...
export default function NewClubConditionPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push(`/admin/conditions/club/${data.id}`);
    } catch (error: any) {
    ...
    <div className="p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Nuevo Template Diamond → Club</h1>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ej: Rakeback Progresivo, Condiciones Premium"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Ej: Condiciones que aumentan con mejor rendimiento del club"
                rows={3}
              />
            </div>
          </CardContent>
